        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              className="input-box w-full p-4 outline-none border-[#00a651]/20 focus:ring-1 focus:ring-green-400"
            />
          </div>
          <div className="space-y-1">
      ...
      {result && (
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="col-span-2 bg-slate-800 text-white p-4 rounded-2xl text-center shadow-sm">
              <p className="text-slate-400 text-[10px] font-bold uppercase mb-1 tracking-widest">{t.totalVol}</p>
              <div className="text-2xl font-black">{result.volume.toFixed(3)}</div>
            </div>
          </div>
        </div>
      )}
